    ...
    <AnimatePresence>
      {open && (
        ...
        >
          ...
          >
            <h2 className="text-lg font-semibold mb-3 text-neutral-800">¿Seguir imprimiendo?</h2>
            ...
            <div className="flex gap-3">
              <Button className="flex-1" onClick={onKeep}>Mantener y seguir</Button>
              <Button className="flex-1 bg-neutral-200 text-neutral-800 hover:bg-neutral-300" onClick={onReset}>
                Nueva configuración
              </Button>
            </div>
          </motion.div>
